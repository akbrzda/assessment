...
router.post("/:id/draft", controller.upsertCourseDraft);
router.get("/:id/draft", controller.getCourseDraft);
router.delete("/:id/draft", controller.deleteCourseDraft);
router.post("/:id/publish-draft", controller.publishCourseDraft);
