...
const adminTheoryModuleController = require('../modules/admin/assessments/theory/assessments-theory.controller');
...
router.get('/admin/:id/theory', requireRole(['superadmin', 'manager']), adminTheoryModuleController.getTheory);
router.put('/admin/:id/theory/draft', requireRole(['superadmin', 'manager']), adminTheoryModuleController.saveDraft);
router.post('/admin/:id/theory/publish', requireRole(['superadmin', 'manager']), adminTheoryModuleController.publish);
