...
| [PROJECT_AUDIT_REPORT.md](PROJECT_AUDIT_REPORT.md)                                                                   | Архитектурный/безопасностный/UI-аудит                | Актуален            | Высокая      | Перекрывает риски из `docs/engineering/*` и `ROADMAP.md`                                          | Оставить источником рисков и улучшений, сверять с фактическим кодом по кварталам     |
...
| [docs/frontend.md](docs/frontend.md)                                                                                 | API одного компонента (`PermissionMatrix`)           | Узкий/локальный     | Низкая       | Пересечение с RBAC docs                                                                           | Перенести в модульную docs-папку компонента или расширить (TASK-029)                 |
| [docs/archive/features-backlog.md](docs/archive/features-backlog.md)                                                 | Сырой исторический backlog                           | Устаревающий архив  | Низкая       | Дублирует задачи в `bot-features`, `ROADMAP`, backlog                                             | Не использовать как источник истины; задачи мигрированы в PROJECT_TASKS_BACKLOG.md   |
...
2. Тема RBAC параллельно ведётся в [docs/engineering/crud-rbac-design.md](docs/engineering/crud-rbac-design.md) и [PROJECT_AUDIT_REPORT.md](PROJECT_AUDIT_REPORT.md).
...
1. [docs/courses/api-contracts.md](docs/courses/api-contracts.md) — покрывает только часть API.
2. [docs/engineering/components.md](docs/engineering/components.md) — не отражает полноценно текущее состояние UI.
3. [docs/archive/features-backlog.md](docs/archive/features-backlog.md) — неструктурированный архив, часть задач уже перенесена в другие документы.
